...
void Update_Valve_Module(int Cycle_Type) {
  ...
  Data_1.valve_relay_states &= 0b1111111111111110;
  Data_1.valve_relay_states |= Conc1_Air_Valve;
  Data_1.valve_relay_states &= 0b1111111111111101;
  Data_1.valve_relay_states |= Conc2_Air_Valve << 1;
  Data_1.valve_relay_states &= 0b1111111111111011;
  Data_1.valve_relay_states |= Conc3_Air_Valve << 2;
  Data_1.valve_relay_states &= 0b1111111111110111;
  Data_1.valve_relay_states |= Conc4_Air_Valve << 3;
  Data_1.valve_relay_states &= 0b1111111111101111;
  Data_1.valve_relay_states |= Conc5_Air_Valve << 4;
  Data_1.valve_relay_states &= 0b1111111111011111;
  Data_1.valve_relay_states |= Conc6_Air_Valve << 5;
  //    Data_1.valve_relay_states &= 0b1111111110111111; Data_1.valve_relay_states |= Decanter_Air_Valve<<6;
  Data_1.valve_relay_states &= 0b1111111011111111;
  Data_1.valve_relay_states |= Conc1_1in_Valve << 8;
  Data_1.valve_relay_states &= 0b1111110111111111;
  Data_1.valve_relay_states |= Conc2_1in_Valve << 9;
  Data_1.valve_relay_states &= 0b1111101111111111;
  Data_1.valve_relay_states |= Conc3_1in_Valve << 10;
  Data_1.valve_relay_states &= 0b1111011111111111;
  Data_1.valve_relay_states |= Conc4_1in_Valve << 11;
  Data_1.valve_relay_states &= 0b1110111111111111;
  Data_1.valve_relay_states |= Conc5_1in_Valve << 12;
  Data_1.valve_relay_states &= 0b1101111111111111;
  Data_1.valve_relay_states |= Conc6_1in_Valve << 13;
  Data_1.valve_relay_states &= 0b1011111111111111;
  Data_1.valve_relay_states |= VFD_Conveyor_Sluice << 14;
